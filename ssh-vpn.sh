...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/demonk1992/down/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/demonk1992/down/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/demonk1992/down/main/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/demonk1992/down/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
wget https://raw.githubusercontent.com/demonk1992/down/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
